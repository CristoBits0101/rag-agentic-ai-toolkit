...
# Descargar un modelo recomendado para DocChat.
ollama pull qwen2.5:7b

# Alternativa de menor consumo.
ollama pull llama3.2:3b

# Opcional para parsing documental avanzado.
