...
- `src/app/infra`: technical adapters (db/cache/vector-db).
- `src/app/modules/capabilities`: reusable AI capabilities (llm, retrieval, agents).
- `src/app/modules/apps`: application-level use cases.
