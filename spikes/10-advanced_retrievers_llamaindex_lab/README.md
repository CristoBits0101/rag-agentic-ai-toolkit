...
1. Compilacion: `python -m compileall spikes\10-advanced_retrievers_llamaindex_lab`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\10-advanced_retrievers_llamaindex_lab\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_10_advanced_retrievers_llamaindex.py`.
