...
1. Compilacion: `python -m compileall spikes\24-langgraph_101_building_stateful_ai_workflows_lab`.
2. Practica: `.\.venv\Scripts\python.exe .\spikes\24-langgraph_101_building_stateful_ai_workflows_lab\main.py`.
3. Tests: `.\.venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_24_langgraph_101_building_stateful_ai_workflows.py`.
