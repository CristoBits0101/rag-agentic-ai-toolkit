...
1. Compilacion: `python -m compileall spikes\22-natural_language_data_visualization_agent_lab`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\22-natural_language_data_visualization_agent_lab\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_22_natural_language_data_visualization_agent.py`.
