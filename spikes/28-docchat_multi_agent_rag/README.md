...
1. Compilacion: `python -m compileall spikes\28-docchat_multi_agent_rag`.
2. Practica CLI: `.\venv\Scripts\python.exe .\spikes\28-docchat_multi_agent_rag\main.py`.
3. App UI: `.\venv\Scripts\python.exe .\spikes\28-docchat_multi_agent_rag\app.py`.
4. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_28_docchat_multi_agent_rag.py`.
