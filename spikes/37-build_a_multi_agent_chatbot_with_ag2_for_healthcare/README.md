...
4. Ejercicio incluido: Se añade el chatbot de salud mental con analisis emocional y recomendaciones de cuidado.
5. Aviso pedagógico: La salida no sustituye atencion medica profesional.
...
1. Compilacion: `python -m compileall spikes\37-build_a_multi_agent_chatbot_with_ag2_for_healthcare`.
2. Practica: `venv\Scripts\python.exe .\spikes\37-build_a_multi_agent_chatbot_with_ag2_for_healthcare\main.py`.
3. Tests: `venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_37_build_a_multi_agent_chatbot_with_ag2_for_healthcare.py`.
