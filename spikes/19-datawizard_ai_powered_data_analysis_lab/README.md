...
1. Compilacion: `python -m compileall spikes\19-datawizard_ai_powered_data_analysis_lab`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\19-datawizard_ai_powered_data_analysis_lab\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_19_datawizard_ai_powered_data_analysis.py`.
