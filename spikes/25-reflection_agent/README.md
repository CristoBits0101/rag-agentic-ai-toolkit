...
1. Compilacion: `python -m compileall spikes\25-reflection_agent`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\25-reflection_agent\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_25_reflection_agent.py`.
