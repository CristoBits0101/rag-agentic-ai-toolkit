...
class Crew:
    ...
    def _render_result(self, task: Task, raw_result: Any) -> str:
    ...
    def kickoff(self, inputs: dict[str, Any]):
        ...
        for index, task in enumerate(self.tasks):
            ...
            rendered = self._render_result(task, raw_result)
            completion_tokens += len(rendered.split())
            task_output = TaskOutput(description=description, raw=rendered, agent=active_agent.role)
