...
3. Sin claves externas: La ejecucion por defecto no necesita `OpenAI` para enseñar la orquestacion.
...
1. Compilacion: `python -m compileall spikes\36-ag2_101_complete_tutorial`.
2. Practica: `venv\Scripts\python.exe .\spikes\36-ag2_101_complete_tutorial\main.py`.
3. Tests: `venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_36_ag2_101_complete_tutorial.py`.
