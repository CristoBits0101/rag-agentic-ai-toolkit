...
1. Compilacion: `python -m compileall spikes\08-food_recommendation_rag`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\08-food_recommendation_rag\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_08_food_recommendation_rag_rag.py`.
