...
1. Compilacion: `python -m compileall spikes\31-crewai_101_building_multi_agent_ai_systems`.
2. Practica: `venv\Scripts\python.exe .\spikes\31-crewai_101_building_multi_agent_ai_systems\main.py`.
3. Tests: `venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_31_crewai_101_building_multi_agent_ai_systems.py`.
