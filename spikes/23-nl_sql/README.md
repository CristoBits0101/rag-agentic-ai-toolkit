...
1. Compilacion: `python -m compileall spikes\23-nl_sql`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\23-nl_sql\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_23_nl_sql.py`.
