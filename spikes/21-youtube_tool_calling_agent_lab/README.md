...
1. Compilacion: `python -m compileall spikes\21-youtube_tool_calling_agent_lab`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\21-youtube_tool_calling_agent_lab\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_21_youtube_tool_calling_agent.py`.
