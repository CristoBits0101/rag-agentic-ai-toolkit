...
1. Compilacion: `python -m compileall spikes\34-building_your_own_ai_nutrition_coach_using_a_multi_agent_system_and_multimodal_ai`.
2. Demo CLI: `venv\Scripts\python.exe .\spikes\34-building_your_own_ai_nutrition_coach_using_a_multi_agent_system_and_multimodal_ai\main.py`.
3. Tests: `venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_34_building_your_own_ai_nutrition_coach_using_a_multi_agent_system_and_multimodal_ai.py`.
4. UI local: `venv\Scripts\python.exe .\spikes\34-building_your_own_ai_nutrition_coach_using_a_multi_agent_system_and_multimodal_ai\app.py`.
