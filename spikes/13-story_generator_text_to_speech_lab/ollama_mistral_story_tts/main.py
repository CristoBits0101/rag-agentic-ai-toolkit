...
from orchestration.story_real_variants_orchestration import run_ollama_mistral_story_variant


def main() -> None:
    try:
        run = run_ollama_mistral_story_variant(DEFAULT_TOPIC)
    except RuntimeError as exc:
        print("OLLAMA MISTRAL STORY TTS")
        print(str(exc))
        return
