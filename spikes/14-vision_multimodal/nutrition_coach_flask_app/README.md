...
5. Ejecutar runner de consola: `.\venv\Scripts\python.exe .\spikes\14-vision_multimodal\nutrition_coach_flask_app\main.py`.
6. Tras validar compilacion y tests puedes lanzar la app web: `.\venv\Scripts\python.exe .\spikes\14-vision_multimodal\nutrition_coach_flask_app\app.py`.
