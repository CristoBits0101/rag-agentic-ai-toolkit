...
1. Compilacion: `python -m compileall spikes\30-langgraph_design_patterns`.
2. Practica: `venv\Scripts\python.exe .\spikes\30-langgraph_design_patterns\main.py`.
3. Tests: `venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_30_langgraph_design_patterns.py`.
