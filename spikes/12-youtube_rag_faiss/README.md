...
1. Compilacion: `python -m compileall spikes\12-youtube_rag_faiss`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\12-youtube_rag_faiss\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_12_youtube_rag_faiss.py`.
