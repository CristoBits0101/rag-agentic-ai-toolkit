...
1. Compilacion: `python -m compileall spikes\11-semantic_similarity_faiss_lab`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\11-semantic_similarity_faiss_lab\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_11_semantic_similarity_faiss.py`.
