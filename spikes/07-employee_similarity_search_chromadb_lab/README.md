...
2. Embeddings locales: Vectores deterministas para evitar dependencias externas.
...
- `models/employee_book_embedding_gateway.py`: Embeddings deterministas para empleados y libros.
...
Esta adaptacion no descarga `SentenceTransformers`. Para mantener la practica ejecutable dentro del repositorio usa embeddings deterministas construidos desde palabras clave de roles habilidades generos temas y ubicaciones.
