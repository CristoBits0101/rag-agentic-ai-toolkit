...
1. Compilacion: `python -m compileall spikes\20-interactive_llm_agents_with_tools_lab`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\20-interactive_llm_agents_with_tools_lab\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_20_interactive_llm_agents_with_tools.py`.
