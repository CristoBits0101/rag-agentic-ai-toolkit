...
def build_design_patterns_model(model_name: str | None = None, tags_loader=list_installed_ollama_models):
    if ChatOllama is None:
        raise RuntimeError("LangChain Ollama is not available. Install langchain-ollama before running practica 30.")
