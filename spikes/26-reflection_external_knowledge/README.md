...
1. Compilacion: `python -m compileall spikes\26-reflection_external_knowledge`.
2. Practica: `.\venv\Scripts\python.exe .\spikes\26-reflection_external_knowledge\main.py`.
3. Tests: `.\venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_26_reflection_external_knowledge.py`.
