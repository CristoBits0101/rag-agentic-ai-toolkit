...
1. Compilacion: `python -m compileall spikes\29-implement_workflow_patterns_with_langgraph`.
2. Practica: `venv\Scripts\python.exe .\spikes\29-implement_workflow_patterns_with_langgraph\main.py`.
3. Tests: `venv\Scripts\python.exe -m pytest -c NUL --rootdir . tests\unit\test_spike_29_implement_workflow_patterns_with_langgraph.py`.
